						...
						<div className="level-one-div">
							...
							<div className="flex-text-level">
								<div className="icon-and-text">
									...
									<div className="punct-level"><strong>Vocabluary:</strong> greetings, countries, nationalities</div>
								</div>
								<div className="icon-and-text">
									<svg width="45" height="41" viewBox="0 0 45 41" fill="none" xmlns="http://www.w3.org/2000/svg">
										<rect y="0.5" width="45" height="40" rx="12" fill="#FE502D"/>
									...
									<div className="punct-level"><strong>Grammar:</strong> present simple be (I, you)</div>
								</div>
								<div className="icon-and-text">
									<svg width="45" height="41" viewBox="0 0 45 41" fill="none" xmlns="http://www.w3.org/2000/svg">
										<rect y="0.5" width="45" height="40" rx="12" fill="#FE502D"/>
									...
									<div className="punct-level"><strong>Reading:</strong> intonation in greetings</div>
								</div>
							</div>

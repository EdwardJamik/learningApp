						...
						<div className="lesson-item">
							...
							<div className="lesson-detail">
								...
								<div className="lesson-description">
									Ви починаєте вивчати англійську мову та знаєте лише кілька слів
									або виразів
								</div>
							</div>
						</div>
								...
								<div className="lesson-title">
									...
									<svg className="current-lesson" width="34" height="34" viewBox="0 0 30 30" fill="none"
										...
										<path
											...
											stroke="#FE502D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
